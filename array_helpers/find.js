...
const peoples = [
  ...
  //main difference between find helper and filter helper is filter returns all the values based on the given condition on the other hand find returns the first value found with the given condition else returns undefined.
  // ------------------------------